...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { language：string: @keyword.language：string, link: @keyword.link, name: @keyword.name, pagenum: @keyword.pagenum }
    end
  ...
  test "should update keyword" do
    put :update, id: @keyword, keyword: { language：string: @keyword.language：string, link: @keyword.link, name: @keyword.name, pagenum: @keyword.pagenum }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
